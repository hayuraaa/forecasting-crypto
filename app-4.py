...
def main():
    ...
    CloseTab, OpenTab, ActualTab, ResultTab = st.tabs(["Close", "Open", "Aqtual", "All Result"])
    with CloseTab:
        # Display results
    ...
    with ResultTab:
        ...
        visualize_predictions_all_pred(data,train_size_open,train_size_close, n_steps, b_pred, y_pred)
...
def visualize_predictions_all_pred(data,train_size_open,train_size_close, n_steps, b_pred, y_pred):
